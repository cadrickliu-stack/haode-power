      ...
      <section className="bg-white py-24">
        <div className="container-wide grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <Reveal delay={100} className="order-1 lg:order-2">
            ...
            <p className="mt-5 text-steel-600">
              Located in Changzhou City, Jiangsu Province — a major
              manufacturing hub in China&apos;s Yangtze River Delta — our
              facility houses fabrication, assembly, testing, and
              warehousing under one roof, with direct rail and port access
            ...
            <ul className="mt-6 space-y-3 text-sm text-steel-600">
              ...
              <li className="flex gap-3"><span className="mt-0.5 text-orange-500">✓</span><span>Under 2 hours from Shanghai Port for container loading</span></li>
            </ul>
          </Reveal>
        </div>
      </section>
